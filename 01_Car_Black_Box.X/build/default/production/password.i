...
unsigned char check_password(void) {
    ...
    while (1) {
        ...
        detected_key = read_switches(1);

        clcd_print((const unsigned char *) "Enter Password", (0x80 + (1)));
        clcd_print((const unsigned char *) "Ch Left", (0xC0 + (0)));
        clcd_putch((const unsigned char) ('0' + (3 - chance)), (0xC0 + (8)));
        clcd_print((const unsigned char *) ": ", (0xC0 + (9)));
        clcd_print(star_arr, (0xC0 + (11)));
        ...
        if (pass_index == 4 && !strcmp((const char *) password, (const char *) user_password)) {
            ...
            clcd_print((const unsigned char *) "Chance finished!", (0x80 + (0)));
            clcd_print((const unsigned char *) "Wait for ", (0xC0 + (0)));
            clcd_print((const unsigned char *) "Sec.", (0xC0 + (12)));
            for (unsigned long int wait_pass = 600; wait_pass--;) {
                clcd_putch((const unsigned char) ('0' + (wait_pass / 100)), (0xC0 + (9)));
                clcd_putch((const unsigned char) ('0' + ((wait_pass / 10) % 10)), (0xC0 + (10)));
...
void reset_password(void) {
    ...
    while (1) {
        ...
        if (pass_count <= 3) {
            ...
            if (detected_key == 11) password[pass_count++] = '1';
            else if (detected_key == 12) password[pass_count++] = '0';

            if (pass_count == 3 + 1) clcd_write(0x01, 0);

        } else {

            clcd_print((const unsigned char *) "Comform Password", (0x80 + (0)));
            clcd_print(user_password, (0xC0 + (6)));
            ...
            if (detected_key == 11) user_password[pass_count++ -4] = '1';
            else if (detected_key == 12) user_password[pass_count++ -4] = '0';
        }
        ...
        if (pass_count >= 2 * (3 + 1)) {
            ...
            if (!strcmp((const char *) user_password, (const char *) password)) {
                ...
                for (pass_count = 0; pass_count <= 3; pass_count++)
                ...
                clcd_print((const unsigned char *) "Password Updated", (0x80 + (0)));
                clcd_print((const unsigned char *) "Successfully", (0xC0 + (2)));

            } else {

                puts("\nPassword Reseting is unsuccessful, try again \n\n\r");
                clcd_print((const unsigned char *) "Pasword Mismatch", (0x80 + (0)));
                clcd_print((const unsigned char *) "Try Again", (0xC0 + (4)));
